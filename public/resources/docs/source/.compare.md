...
[Get Postman Collection](http://localhost/ba/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "http://localhost/ba/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"corporis","ip_address":"aut","latitude":"et","longitude":"fugiat"}'
...
```bash
curl -X POST \
    "http://localhost/ba/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"qui","latitude":"et","longitude":"a"}'
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/holidays?location_id=alias&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=perferendis&follow_up_type=et&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/crm/follow-ups"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "http://localhost/ba/public/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"perferendis","schedule_type":"consequatur","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=at&biz_name=assumenda&mobile_num=6&contact_id=perferendis&order_by=explicabo&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "http://localhost/ba/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"illum","mobile_name":"hic","call_type":"call","start_time":"commodi","end_time":"animi","duration":"voluptatem"}]}'
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=in&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":13,"initial_amount":63262883.244855,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":40152.88771,"total_card_slips":1,"total_cheques":8,"closing_note":"natus","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 13,
    "initial_amount": 63262883.244855,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 40152.88771,
    "total_card_slips": 1,
    "total_cheques": 8,
    "closing_note": "natus",
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/contactapi?type=quia&name=corrupti&biz_name=distinctio&mobile_num=20&contact_id=esse&order_by=consequatur&direction=laudantium&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"voluptatem","prefix":"tempora","first_name":"doloremque","middle_name":"soluta","last_name":"in","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"similique","address_line_2":"ullam","city":"consectetur","state":"fugiat","country":"sapiente","zip_code":"enim","customer_group_id":"quia","contact_id":"facilis","dob":"2000-06-13","custom_field1":"esse","custom_field2":"aspernatur","custom_field3":"alias","custom_field4":"molestiae","email":"dolores","shipping_address":"tenetur","position":"maiores","opening_balance":0,"source_id":20,"life_stage_id":14,"assigned_to":[]}'
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"incidunt","prefix":"eos","first_name":"voluptatum","middle_name":"sit","last_name":"numquam","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"perferendis","address_line_2":"sint","city":"qui","state":"eligendi","country":"voluptate","zip_code":"minus","customer_group_id":"vel","contact_id":"hic","dob":"2000-06-13","custom_field1":"voluptas","custom_field2":"nostrum","custom_field3":"veritatis","custom_field4":"aut","email":"molestias","shipping_address":"quisquam","position":"hic","opening_balance":10.3,"source_id":10,"life_stage_id":19,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "incidunt",
    "prefix": "eos",
    ...
    "custom_field3": "veritatis",
    "custom_field4": "aut",
    "email": "molestias",
    "shipping_address": "quisquam",
    "position": "hic",
...
```bash
curl -X POST \
    "http://localhost/ba/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":6,"card_number":"quasi","card_holder_name":"non","card_transaction_number":"et","card_type":"et","card_month":"maxime","card_year":"fugiat","card_security":"sunt","transaction_no_1":"fuga","transaction_no_2":"facere","transaction_no_3":"et","cheque_number":"fugit","bank_account_number":"debitis","note":"dicta"}'
...
let body = {
    ...
    "card_year": "fugiat",
    "card_security": "sunt",
    "transaction_no_1": "fuga",
    "transaction_no_2": "facere",
    "transaction_no_3": "et",
    "cheque_number": "fugit",
    "bank_account_number": "debitis",
    "note": "dicta"
}
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/expense?location_id=nostrum&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=accusamus&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":19,"final_total":339.75664,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":13,"expense_for":12,"contact_id":5,"additional_notes":"doloribus","is_refund":0,"is_recurring":0,"recur_interval":14,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"minima","recur_repetitions":7,"payment":[{"amount":453.13,"method":"cash","account_id":16,"card_number":"ipsam","card_holder_name":"soluta","card_transaction_number":"optio","card_type":"non","card_month":"eos","card_year":"dolor","card_security":"quas","transaction_no_1":"sint","transaction_no_2":"aut","transaction_no_3":"autem","note":"quia","cheque_number":"sequi"}]}'
    ...
    "payment": [
        {
            ...
            "card_year": "dolor",
            "card_security": "quas",
            "transaction_no_1": "sint",
            "transaction_no_2": "aut",
            "transaction_no_3": "autem",
            "note": "quia",
            "cheque_number": "sequi"
        }
    ]
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "http://localhost/ba/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":7.602,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":13,"expense_for":15,"contact_id":13,"additional_notes":"ex","is_recurring":0,"recur_interval":11,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"quia","recur_repetitions":2,"payment":[]}'
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/expense-refund?location_id=ipsa&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=quas&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/product?brand_id=nam&category_id=tenetur&sub_category_id=similique&location_id=officiis&selling_price_group=dolores&name=incidunt&sku=soluta&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/product"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/product/1?selling_price_group=quia" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/product/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/variation/?brand_id=aut&category_id=dolores&sub_category_id=enim&not_for_selling=voluptatem&name=ipsam&sku=molestias&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/variation/"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/sell?location_id=animi&contact_id=non&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=nostrum&service_staff_id=iure&shipping_status=ordered&only_subscriptions=molestiae&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/sell"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":3,"contact_id":1,"transaction_date":"2020-07-22 15:48:29","invoice_no":"nobis","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":14,"discount_amount":10,"discount_type":"fixed","sale_note":"iusto","staff_note":"mollitia","commission_agent":5,"shipping_details":"Express Delivery","shipping_address":"dolores","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":11,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":13,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"minima","recur_repetitions":3,"rp_redeemed":1,"rp_redeemed_amount":13.5,"types_of_service_id":5,"service_custom_field_1":"ipsa","service_custom_field_2":"fuga","service_custom_field_3":"tenetur","service_custom_field_4":"aut","round_off_amount":0,"table_id":4,"service_staff_id":4,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":13,"note":"ut"}],"payments":[{"amount":453.13,"method":"cash","account_id":16,"card_number":"eum","card_holder_name":"commodi","card_transaction_number":"eaque","card_type":"accusantium","card_month":"eos","card_year":"quis","card_security":"impedit","transaction_no_1":"ab","transaction_no_2":"aut","transaction_no_3":"incidunt","bank_account_number":"totam","note":"repudiandae","cheque_number":"voluptatem"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_1": "ipsa",
            "service_custom_field_2": "fuga",
            "service_custom_field_3": "tenetur",
            "service_custom_field_4": "aut",
            "round_off_amount": 0,
            "table_id": 4,
            "service_staff_id": 4,
            "change_return": 0,
            ...
            "payments": [
                {
                    ...
                    "card_transaction_number": "eaque",
                    "card_type": "accusantium",
                    "card_month": "eos",
                    "card_year": "quis",
                    "card_security": "impedit",
                    "transaction_no_1": "ab",
                    "transaction_no_2": "aut",
                    "transaction_no_3": "incidunt",
                    "bank_account_number": "totam",
                    "note": "repudiandae",
                    "cheque_number": "voluptatem"
                }
            ]
        }
    ]
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "http://localhost/ba/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":1,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":3,"discount_amount":10,"discount_type":"fixed","sale_note":"nulla","staff_note":"asperiores","sells":[{"is_suspend":false}],"commission_agent":20,"shipping_details":"Express Delivery","shipping_address":"ut","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":16,"pay_term_number":2,"pay_term_type":"months","is_recurring":0,"recur_interval":20,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"ea","recur_repetitions":10,"rp_redeemed":18,"rp_redeemed_amount":13.5,"types_of_service_id":10,"service_custom_field_1":"aut","service_custom_field_2":"sapiente","service_custom_field_3":"harum","service_custom_field_4":"libero","round_off_amount":1066.2,"table_id":1,"service_staff_id":6,"change_return":0,"change_return_id":8,"products":[{"sell_line_id":17,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":10,"discount_amount":0,"discount_type":"percentage","sub_unit_id":11,"note":"est"}],"payments":[{"payment_id":16,"amount":453.13,"method":"cash","account_id":5,"card_number":"est","card_holder_name":"vitae","card_transaction_number":"ut","card_type":"minima","card_month":"impedit","card_year":"animi","card_security":"voluptatum","transaction_no_1":"hic","transaction_no_2":"veritatis","transaction_no_3":"hic","note":"iure","cheque_number":"aliquam","bank_account_number":"dolorem"}]}'
...
let body = {
    ...
    "service_custom_field_1": "aut",
    "service_custom_field_2": "sapiente",
    "service_custom_field_3": "harum",
    "service_custom_field_4": "libero",
    "round_off_amount": 1066.2,
    "table_id": 1,
    "service_staff_id": 6,
    "change_return": 0,
    "change_return_id": 8,
    ...
    "payments": [
        {
            ...
            "transaction_no_3": "hic",
            "note": "iure",
            "cheque_number": "aliquam",
...
```bash
curl -X DELETE \
    "http://localhost/ba/public/connector/api/sell/vitae" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "http://localhost/ba/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":19,"transaction_date":"2020-5-7 15:20:22","invoice_no":"libero","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":11,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "http://localhost/ba/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":5,"shipping_status":"ordered","delivered_to":"harum"}'
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/table?location_id=dolor" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/taxonomy?type=soluta" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/user/loggedin"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/user?service_staff=cum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/user"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "http://localhost/ba/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"nisi","new_password":"corporis"}'
...
let body = {
    "current_password": "nisi",
    "new_password": "corporis"
}
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/profit-loss-report?location_id=sed&start_date=2018-06-25&end_date=2018-06-25&user_id=corporis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "http://localhost/ba/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/ba/public/connector/api/notifications"
);
