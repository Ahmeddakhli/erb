		...
		<div class="box-body">
			<div class="row">
				...
				@endif
					...
					<div class="col-md-3 project_contact_filter">
                   <div class="form-group">
                        {!! Form::label('project_contact_filter', __('role.customer') . ':' )!!}
                        {!! Form::select('project_contact_filter',$customers, null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'style' => 'width: 100%;']); !!}
                   </div>
                </div>
