...
class ModuleUtil extends Util
{
    ...
    public function isModuleInstalled($module_name)
    {
       ...
       /**
     * This function return array of accont feailds to store new accont.
     *
     * 
     * @return array
     */
    public function account_feilds()
    {
        $account_feilds = [
     ...
     * @return array
     */
    public function store_account($array,$request)
    {
