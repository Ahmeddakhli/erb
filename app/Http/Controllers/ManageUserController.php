...
class ManageUserController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('manage_user.create')
                ->with(compact('roles', 'username_ext', 'locations', 'form_partials','account_types'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $account_feilds = $this->moduleUtil->account_feilds();

            $account_feilds['name']= $request->username;
            $account_feilds['account_type_id']= $request->account_type_id;

            $account = $this->moduleUtil->store_account($account_feilds,$request);
