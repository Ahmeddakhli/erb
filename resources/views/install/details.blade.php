              ...
              <form class="form" id="details_form" method="post" 
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="Brand" type="text" class="form-control" name="APP_NAME" id="app_name" placeholder="brand POS" required>
                    </div>
                  </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <input type="hidden" name="ENVATO_PURCHASE_CODE" value="11111" required class="form-control" id="envato_purchase_code">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <input type="hidden" name="ENVATO_USERNAME" value="11111" required class="form-control" id="envato_username">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">

                      <input hiddenvalue="info@newidea.link" type="hidden" name="ENVATO_EMAIL" class="form-control" id="envato_email" placeholder="optional">
                    </div>
                </div>
                  ...
                  @if($activation_key)
                    <div class="col-md-6">
                      <div class="form-group">
                          <input type="password" value="11111" name="MAC_LICENCE_CODE" required class="form-control" id="activation_licence_code">
                      </div>
                    </div>
                  @endif
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="localhost" class="form-control" id="db_host" name="DB_HOST" required placeholder="localhost / 127.0.0.1">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email" value="info@newidea.link" class="form-control" id="MAIL_FROM_ADDRESS" name="MAIL_FROM_ADDRESS" placeholder="hello@newidea.link" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="MAIL_FROM_NAME" name="MAIL_FROM_NAME" placeholder="brand POS (Optional)">
                    </div>
                  </div>
